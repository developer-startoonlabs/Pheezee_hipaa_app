...
public class DeviceErrorCodesAndDialogs {
    ...
    static String error_message="Device is facing issue. Please contact us at customercare@start.com to resolve.";
    ...
    public static String getErrorCodeString(byte[] information_packet){
        ...
        error_message = "Device is facing issue. Please contact us at customercare@start.com to resolve.";
        try {
            ...
            if((information_packet[2]&0xFF)==0 && (information_packet[7]&0xFF)==0 && (information_packet[3]&0xFF)==0 && (information_packet[8]&0xFF)==0 && (information_packet[5]&0xFF)==0 && (information_packet[6]&0xFF)==0 && (information_packet[4]&0xFF)==1)
            {
                ...
                error_message = "EMG view is restricted. Please contact us at customercare@start.com to resolve.";
            ...
            {
                error_heading = "Device Alert ";
                 error_message ="Battery status is not communicated. Please contact us at customercare@start.com to resolve.";
            }
