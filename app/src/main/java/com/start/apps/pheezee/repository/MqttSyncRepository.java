...
public class MqttSyncRepository {
    ...
    public interface fetchRefreshToken {
        void onrefreshToken(boolean response, String refreshToken);
    }
                ...
                public void onResponse(@NonNull Call<ResponseData> call, @NonNull Response<ResponseData> response) {
                    if (response.code() == 200) {
                        ...
                        if (responseData != null) {
                            if (responseData.getResponse().equalsIgnoreCase("PatientAdded"))
                ...
                if(response.code() == 200) {
                    ...
                    if (res != null) {
                        if (res.equalsIgnoreCase("invalid")) {
                            ...
                            if (loginlistner != null) {
                                loginlistner.onForgotPasswordResponse(true, otp,res);
                            }
                        }
                    } else {
                        if (loginlistner != null)
    ...
    public void resetPassword(String phiziopassword,String token) {
        LoginResp resp = new LoginResp(phiziopassword);
        Call<String> resetPassword = getDataService.resetPassword(token,resp);
        resetPassword.enqueue(new Callback<String>() {
            @Override
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                if (response.code() == 200) {
                    String res = response.body();
                    Log.d(response.body(),"Kranthi1");
                    if (res != null) {
    ...
    public void updateApp_version(String email, String app_version) {
        ...
        Call<String> update_appversion_call = getDataService.updateApp_version(data, "Bearer " + sharedPref.getString("accessToken", ""));
...
//                            loginlistner.onPasswordUpdated("Error please try later");
    ...
    public void sendVerificationEmail(String email) {
        ...
        Call<String> confirm_email = getDataService.sendVerificationEmail(password);
                ...
                if (response.code() == 200) {
                    ...
                    if (res != null) {
                        if (signUpResponse != null) {
                            signUpResponse.onConfirmEmail(true, otp, res);
                        }
...
//                        }
    ...
    public void verifyEmail(String token) {
        Call<String> verifyEmail = getDataService.verifyEmail(token);
        verifyEmail.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
    ...
    public void signUp(SignUpData data) {
        Call<List<SignupResult>> sign_up = getDataService.signUp(data);
        sign_up.enqueue(new Callback<List<SignupResult>>() {
            @SuppressLint("ApplySharedPref")
            @Override
            public void onResponse(@NonNull Call<List<SignupResult>> call, @NonNull Response<List<SignupResult>> response) {
                if (response.code() == 201) {

                    List<SignupResult> res = response.body();
                    System.out.println(res.get(0).getAccessToken() + " " + res.get(0).getRefreshToken());
                    sendVerificationEmail(res.get(0).getPhizioemail());
                    if (res != null) {
                        if (res.get(0).getResponse() == "inserted") {
                            editor = sharedPref.edit();
                            editor.putBoolean("isLoggedIn", true);
                            JSONObject jsonObject = new JSONObject();
                            try {
                                jsonObject.put("phizioname", res.get(0).getPhizioname());
                                jsonObject.put("phizioemail", res.get(0).getPhizioemail());
                                jsonObject.put("phiziophone", res.get(0).getPhiziophone());
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }

                            editor.putString("phiziodetails", jsonObject.toString());
                            editor.putString("accessToken", res.get(0).getAccessToken());
                            editor.putString("accessTokenExpires", res.get(0).getAccessTokenExpires());
                            editor.putString("refreshToken", res.get(0).getRefreshToken());
                            editor.putString("refreshTokenExpires", res.get(0).getRefreshTokenExpires());
                            editor.apply();
                        ...
                        } else if(res.get(0).getResponse() == "already"){
                            if (signUpResponse != null) {
            ...
            @Override
            public void onFailure(@NonNull Call<List<SignupResult>> call, @NonNull Throwable t) {
                if (signUpResponse != null) {
                    signUpResponse.onSignUp(false);
                }
            }
...
//                                    if(results.contains("clinicname")) {
//
//                                        if(results.get(0).getClinicname() == "") {
//                                            object.put("clinicname", "");
//                                        } else {
//                                            object.put("clinicname", results.get(0).getClinicname());
//                                        }
//                                    } else {
//                                        object.put("clinicname", "");
//                                    }
//                                    if(results.contains("cliniclogo")) {
//                                        if (results.get(0).getCliniclogo() == "") {
//                                            object.put("cliniclogo", null);
//                                        } else {
//                                            object.put("cliniclogo", results.get(0).getCliniclogo());
//                                        }
//                                    } else {
...
//                                    }
                                    ...
                                    if(results.contains("packagetype")){
                                ...
                                editor.putString("accessToken", results.get(0).getAccessToken());
                                editor.putString("accessTokenExpires", results.get(0).getAccessTokenExpires());
                                editor.putString("refreshToken", results.get(0).getRefreshToken());
                                editor.putString("refreshTokenExpires", results.get(0).getRefreshTokenExpires());
                                editor.commit();
    ...
    public void updatePhizioDetails(PhizioDetailsData data) {
        Call<String> update_phizio_details = getDataService.updatePhizioDetails(data,"Bearer " + sharedPref.getString("accessToken", ""));
...
//                    System.out.println(lel.get(0).getSessiondetails().get(0).getHeldon());
                ...
                if (response.code() == 200) {
                    ...
                    if (res != null) {
                        if (res.getResponse().equalsIgnoreCase("deleted")) {
                            ...
                            Log.i(String.valueOf(res.getId()),"kranthi_id_testing");
                            if (onSessionDataResponse != null)
    ...
    public void fetchRefreshToken(AccessTokenRequestBody data){
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                RefreshAccessTokenResponse rtoken = new RefreshAccessTokenResponse();
                Call<RefreshAccessTokenResponse> call = getDataService.fetchRefreshToken(data);
                call.enqueue(new Callback<RefreshAccessTokenResponse>() {
                    ...
                    public void onResponse(Call<RefreshAccessTokenResponse> call, Response<RefreshAccessTokenResponse> response) {
                        if(response.code() == 200){
                            RefreshAccessTokenResponse results = response.body();
                            editor = sharedPref.edit();
                            editor.putBoolean("isLoggedIn", true);
                            JSONObject object = new JSONObject();
                            ...
                            editor.putString("accessTokenExpires", results.getAccessTokenExpires());
                            editor.putString("refreshToken", results.getRefreshToken());
                            editor.putString("refreshTokenExpires", results.getRefreshTokenExpires());
                            editor.commit();
                        }
                    }
    ...
    public interface OnSignUpResponse{
        void onConfirmEmail(boolean response, String message, String token);
    ...
    public interface OnLoginResponse{
        ...
        void onForgotPasswordResponse(boolean response, String message, String token);
