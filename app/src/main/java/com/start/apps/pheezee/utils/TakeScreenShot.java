...
public class TakeScreenShot {
    ...
    public File takeScreenshot(PopupWindow popupWindow) {
        ...
        try {
            ...
            String mPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/" + now + ".jpg";
            String child = patientname+patientid;
            File f1 =  new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+"/Pheezeenew/files/Monitor",child);
